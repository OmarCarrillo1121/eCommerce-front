  ...
  return (
    <>
      <div className={style.tabletUsers}>
        ...
        <Select filterRol={filterRol} handleChange={handleChange} />
        <table>
          <thead>
              ...
              currentPageData.map((user, index) => {
                ...
                return (
                  <tr className={`${style.row} ${rowClass}`} key={user.id}>
                    ...
                    <td>
                      <button onClick={() => openInfo(user)}>🛈</button>
                    </td>
                  </tr>
                );
              })
        ...
        <div className={style.containerMessage}>
          <p>
            <b>Didn't find what are looking for?</b> Some users may be hidden
            because of the filters you've selected.
          </p>
          <button className={style.showUsers} onClick={showAllUsers}>
            Show all users
          </button>
          {users.length !== 1 ? (
